 ...
 *
 * @author Sean Owen
 * @see ChenCode93Reader
 */
public final class ChenCode39Reader extends OneDReader {
	 ...
	 */
	public ChenCode39Reader(boolean usingCheckDigit) {
	 ...
	 *            the text.
	 */
	public ChenCode39Reader(boolean usingCheckDigit, boolean extendedMode) {
	...
	public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> hints)
		...
		return new Result(resultString, null,
				new ResultPoint[] { new ResultPoint(left, rowNumber), new ResultPoint(right, rowNumber) },
