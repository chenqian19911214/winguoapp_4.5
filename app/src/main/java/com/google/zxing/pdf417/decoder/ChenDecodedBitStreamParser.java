...
import com.google.zxing.common.ChenDecoderResult;
 ...
 */
final class ChenDecodedBitStreamParser {
  ...
  private ChenDecodedBitStreamParser() {
  }

  static ChenDecoderResult decode(int[] codewords, String ecLevel) throws FormatException {
    ...
    ChenDecoderResult decoderResult = new ChenDecoderResult(null, result.toString(), null, ecLevel);
