...
public abstract class BaseCaptureActivity extends Activity implements 
    SurfaceHolder.Callback,OnRequestPermissionsResultCallback {
	...
	public void onRequestPermissionsResult(int arg0, String[] arg1, int[] arg2) {
		...
		if (arg0==1) {
			...
			if (arg2[0]==PackageManager.PERMISSION_GRANTED) {//相机申请成功
				

			}else{//相机申请失败
				com.winguo.utils.Intents.noCameraPermissionStatus(this, getString(R.string.camera_no_work_text1),getString(R.string.no_start_camera));
	...
	private void displayFrameworkBugMessageAndExit() {
		...
		builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
				ActivityCompat.requestPermissions(BaseCaptureActivity.this, new String[]{
