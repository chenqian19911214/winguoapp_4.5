...
final class ChenDecodedBitStreamParser {
  ...
  static ChenDecoderResult decode(byte[] bytes) throws FormatException {
    ...
    return new ChenDecoderResult(bytes, result.toString(), byteSegments.isEmpty() ? null : byteSegments, null);
  }
