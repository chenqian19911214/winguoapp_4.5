 ...
 * @desc 自定义商品评论
 */
public class EvaluateArrBean implements Serializable{
    ...
    public static class ReviewListBean implements Serializable{
        ...
        public static class ItemsBean implements Serializable{
            ...
            private List<EvaluateItemBean> item;

            public List<EvaluateItemBean> getItem() {
                return item;
            }

            public void setItem(List<EvaluateItemBean> item) {
                this.item = item;
            }
        }
    }
