...
public class TabPagerIndicator extends HorizontalScrollView {
    ...
    private int dividerPadding = 5;//10小尺寸,
    //表示字体之间的间隔
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, height, tabsContainer.getWidth(), height, rectPaint);
        //分割线
        // draw divider
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            Log.v("hcpai", "lastSelectPosition:=" + lastSelectPosition);
            Log.v("hcpai", "selectCurPotition:=" + selectCurPotition);
