...
public class StoreOrderWaitPayFragment extends BaseFragment2 implements View.OnClickListener, BaseQuickAdapter.RequestLoadMoreListener, StoreOrderAdapter.IBaseViewHolderListener, BaseQuickAdapter.OnItemClickListener {
    ...
    private void requestData() {
        if (NetworkUtils.isConnectNet(mContext)) {
            ...
            StoreOrderControl.requestStoreOrder(mContext,mId, 1, 1, new StoreOrderControl.IStoreOrder() {
                @Override
